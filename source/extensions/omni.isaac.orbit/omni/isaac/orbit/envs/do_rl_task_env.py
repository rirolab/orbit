...
# 24.01.14
# Chanyoung Ahn
# Add final success checker & initial dummy steps
...
VecDoEnvStepReturn = Tuple[VecEnvObs, torch.Tensor, torch.Tensor, torch.Tensor, Dict]
...
class RLDOTaskEnv(BaseEnv, gym.Env):
    ...
    def __init__(self, cfg: RLDOTaskEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def step(self, action: torch.Tensor) -> VecDoEnvStepReturn:
