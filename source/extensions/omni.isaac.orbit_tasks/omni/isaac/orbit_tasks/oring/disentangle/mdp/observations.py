...
from omni.isaac.orbit.assets import DeformObject
...
def object_embedding(
    ...
    object: DeformObject = env.scene[object_cfg.name] 
    
    return env.latent_vectors #FIXME: latent_vectors to deform object? depends on pcd_util implementation
...
def object_transformation(
    ...
    return env.scale_factors #FIXME: scale_factors to deform object? depends on pcd_util implementation
