...
from omni.isaac.orbit_tasks.deformable.disentangle import mdp
from omni.isaac.orbit_tasks.deformable.disentangle.disentangle_env_cfg import DisentangleEnvCfg
...
@configclass
class FrankaOringDisentangleEnvCfg(DisentangleEnvCfg):
    def __post_init__(self):
        ...
        self.actions.body_joint_pos = mdp.JointPositionActionCfg(
            asset_name="robot", joint_names=['joint_x', 'joint_y', 'joint_z', 'rev_z'], scale=0.5, use_default_offset=True
        )
        ...
        # Set Oring as object #FIXME: change to oring
...
@configclass
class FrankaOringDisentangleEnvCfg_PLAY(FrankaOringDisentangleEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a smaller scene for play
        self.scene.num_envs = 4 
        self.scene.env_spacing = 2.5 #FIXME
